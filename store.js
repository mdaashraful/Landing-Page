...
function handleSearch() {
    const searchInputElement = document.getElementById("searce-input-field");
...
const loadPhone = async(searchText) => {
  const res = await fetch(`http://http//openapi.programming-hero.com/api/phones?search=${searchText}`);
